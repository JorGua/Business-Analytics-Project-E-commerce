...
## Task
Build funnels,cohorts, and gain insights.
## Data
...
## Results
### Conversion Funnel
29% of users are adding products to their carts, but are not completing their orders, and only 10% of total users actually purchase a product.
### Retention Rates	
The retention rates show that very few users continue to make purchases since their fist purchase, being 13% retention in the 2020-09 cohort the highest percentage.
